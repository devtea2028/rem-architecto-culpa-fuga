<div align="center">
  ...
  <h1>@devtea2028/rem-architecto-culpa-fuga</h1>
  <p>ESLint plugin for Jest</p>
</div>

[![Actions Status](https://github.com/devtea2028/rem-architecto-culpa-fuga/actions/workflows/nodejs.yml/badge.svg?branch=main)](https://github.com/devtea2028/rem-architecto-culpa-fuga/actions)

## Installation

```bash
yarn add --dev eslint @devtea2028/rem-architecto-culpa-fuga
```

**Note:** If you installed ESLint globally then you must also install
`@devtea2028/rem-architecto-culpa-fuga` globally.
...
```js
const jest = require('@devtea2028/rem-architecto-culpa-fuga');
...
💼
[Configurations](https://github.com/devtea2028/rem-architecto-culpa-fuga/blob/main/README.md#shareable-configurations)
enabled in.\
⚠️ [Configurations](https://github.com/devtea2028/rem-architecto-culpa-fuga/blob/main/README.md#shareable-configurations)
set to warn in.\
✅ Set in the `recommended`
[configuration](https://github.com/devtea2028/rem-architecto-culpa-fuga/blob/main/README.md#shareable-configurations).\
🎨 Set in the `style` [configuration](https://github.com/devtea2028/rem-architecto-culpa-fuga/blob/main/README.md#shareable-configurations).\
...
### @devtea2028/rem-architecto-culpa-fuga-extended

This is a sister plugin to `@devtea2028/rem-architecto-culpa-fuga` that provides support for the
matchers provided by
[`jest-extended`](https://github.com/jest-community/jest-extended).

<https://github.com/devtea2028/rem-architecto-culpa-fuga-extended>

### @devtea2028/rem-architecto-culpa-fuga-formatting

This project aims to provide formatting rules (auto-fixable where possible) to
ensure consistency and readability in jest test suites.

<https://github.com/dangreenisrael/@devtea2028/rem-architecto-culpa-fuga-formatting>
